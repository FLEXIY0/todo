...
<p align="center"><sub>зачёркивание → подзадачи → перетаскивание категории → смена тем</sub></p>
...
- **What's new** — история изменений прямо в приложении, оформленная как GitHub-дифф с `+`/`−`
- **Всё на жестах** — ни одной лишней кнопки в интерфейсе
- **Автосохранение** — состояние живёт в `localStorage`, переживает перезапуск
- **Без сети, без аналитики, без разрешений** — приложение вообще ничего не просит
...
| Свайп вправо | Открыть шторку с темами |
...
app.js       — состояние, рендер, действия с задачами, анимации
